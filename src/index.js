...
const RNSchedule = ({hourSize, dataArray, headerColor, leftIcon, accentColor, status_bar, onEventPress, currentDate, hideDatePicker, renderApptView, theme = {}}) => {
        ...
        <SmartScroll hour_size={hourSize}>
          <View style={styles.body}>
            ...
            <View style={styles.schedule_col}>
              ...
              { !!data && <ScheduledData dataArray={data} onEventPress={onEventPress} currentDate={currentDate} theme={theme} renderApptView={renderApptView}/> }
            </View>
          </View>
        </SmartScroll>
      </View>
